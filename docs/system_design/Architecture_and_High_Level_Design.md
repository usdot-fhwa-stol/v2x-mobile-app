...
The V2X-Mobile-App application is comprised of a number of pages, models, services and views. The basic functionality of each subcomponent group is described below
...
[**Home Page**](https://usdot-carma.atlassian.net/wiki/spaces/spectrum "https://usdot-carma.atlassian.net/wiki/spaces/spectrum") **-** Main landing page of the V2X-Mobile-App application, allows user to open the settings page, or to configure themselves as a vehicle or pedestrian. When in developer mode, this page also shows a button to access the developer page.
...
[**Map Page**](https://usdot-carma.atlassian.net/wiki/spaces/spectrum/pages/3786342431 "https://usdot-carma.atlassian.net/wiki/spaces/spectrum/pages/3786342431") **-** The map page is the core of the V2X-Mobile-App application and provides critical information to the user such as the location of nearby devices, Traveler Information Message alerts, and countdown information for traffic lights.
...
[**Geometry Service**](https://github.com/usdot-fhwa-stol/v2x-mobile-app/blob/develop/cv_mec/lib/services/geometry_service.dart "https://github.com/usdot-fhwa-stol/v2x-mobile-app/blob/develop/cv_mec/lib/services/geometry_service.dart") **-** The Geometry Service handles all of the geospatial calculations in the V2X-Mobile-App application.

[**Timing Service**](https://github.com/usdot-fhwa-stol/v2x-mobile-app/blob/develop/cv_mec/lib/services/timing.dart "https://github.com/usdot-fhwa-stol/v2x-mobile-app/blob/develop/cv_mec/lib/services/timing.dart") **-** The timing service provides a central source of truth for time within the V2X-Mobile-App application. This service ensures time is monatomic within the application and helps to ensure app timing accuracy and consistency.
...
![V2X_Mobile_App Architecture Breakdown](images/Architecture_and_High_Level_Design/V2X_Mobile_App_Architecture_Breakdown.png)

# Network Architecture Graph

This graphic shows all of the connections used for interconnecting the various components of the V2X-Mobile-App application with the V2X partner API.

![Network Architecture Graph](images/Architecture_and_High_Level_Design/Network_Architecture_Graph.png)


The Graphic below is a simplified version of above which shows the steps required for connecting the V2X-Mobile-App mobile application to the Verizon ETX Platform. The steps are as follows.
