...
![MQTT Brokers Button Bicycle](MQTT_Brokers_Button_Bicycle.png)
![MQTT Brokers Button Vehicle](MQTT_Brokers_Button_Vehicle.png)
...
![Car Icon Button Bicycle](Car_Icon_Button_Bicycle.png)
![Car Icon Button Vehicle](Car_Icon_Button_Vehicle.png)
...
![Log Data Button Bicycle](Log_Data_Button_Bicycle.png)
![Log Data Button Vehicle](Log_Data_Button_Vehicle.png)
...
![Home_Map_Settings_Button_Bicycle](Home_Map_Settings_Button_Bicycle.png)
![Home_Map_Settings_Button_Vehicle](Home_Map_Settings_Button_Vehicle.png)
...
The “Vehicle Stats” allows users to click “Connect to ![OBD-II_Connection](OBD-II_Connection.png)". This button will show “Select a Device”, which is a list of devices that are available for the user to connect to.

The MPH or Miles Per Hour will show the rate of speed the user is traveling in a vehicle.

![Vehicle Stats](Vehicle_Stats.png)
