...
![Vehicle_Button](Vehicle_Button.png)
...
![Vehicle_Classification](Vehicle_Classification.png)
    
6.  OBD-II_Connection (Optional- see [OBD-II_Setup](<OBD-II_Setup.md>))

![OBD-II_Connection](OBD-II_Connection.png)
...
![Test_Vehicle_1](Test_Vehicle_1.png)

**Step 4:** Click “Save”

![Save_Test_Vehicle_1](Save_Test_Vehicle_1.png)
...
![Choose_a_Vehicle](Choose_a_Vehicle.png)

The user can delete the vehicle by clicking the trash can icon.

![Trash_Can_Icon](Trash_Can_Icon.png)
...
![Sub_Trash_Can_Icon](Sub_Trash_Can_Icon.png)
...
![Bus_Vehicle_on_Map](Bus_Vehicle_on_Map.png)
